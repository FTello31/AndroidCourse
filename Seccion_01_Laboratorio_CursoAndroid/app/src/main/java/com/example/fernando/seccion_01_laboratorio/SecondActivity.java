package com.example.fernando.seccion_01_laboratorio;
...
public class SecondActivity extends AppCompatActivity {
    ...
    // Otros valores
    private String name = ""; // nombre que recibimos
    private int age = 18; // edad qu eense;amos por defecto
    private final int MAX_AGE = 60;// se hace final porque no va a cambiar
    private final int MIN_AGE = 16;

    //  Para compartir
    public static final int GREETER_OPTION = 1;// statica para que sean accesibles para otros contextos
    public static final int FAREWELL_OPTION = 2;// statica para que sean accesibles para otros contextos
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Evento change para el SeekBar // change cuando cambia su estado lanza algunos de los 3 metodos, se sobreescribe los 3 metodos
        seekBarAge.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int currentAge, boolean b) {
                //valores que llegan
                age = currentAge;
                textViewAge.setText(age + ""); // enseñamos el valor
            }
        ...
        // Evento click del botón para pasar al siguiente Activity (Thrid)
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int option = (radioButtonGreeter.isChecked()) ? GREETER_OPTION : FAREWELL_OPTION; // si esta activo... le damos el valor GREETER_OPTION si no FAREWELL_OPTION

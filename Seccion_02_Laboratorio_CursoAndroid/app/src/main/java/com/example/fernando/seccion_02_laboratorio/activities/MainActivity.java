package com.example.fernando.seccion_02_laboratorio.activities;
...
import com.example.fernando.seccion_02_laboratorio.R;
import com.example.fernando.seccion_02_laboratorio.adapters.FruitAdapter;
import com.example.fernando.seccion_02_laboratorio.models.Fruit;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    // Items en el option menu, declaracion de nustros optionMenu
    private MenuItem itemListView;
    private MenuItem itemGridView;

    // Variables
    private int counter = 0; // para los nuevos elementos
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.fruits = getAllFruits(); // nos va a dar todas las frutas y la cargamos en nuestra coleccion de frutas

        //los rescatamos el layout
        this.listView = (ListView) findViewById(R.id.listView); //mostramos el listview por defecto
        this.gridView = (GridView) findViewById(R.id.gridView);

        // Adjuntando el mismo método click para ambos , luego se sobreescribe el metodo onItemClick
...
//muestra el icono en el action bar
    ...
    //ejecutado tanto en el gridView como el listview
    @Override
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
        this.clickFruit(fruits.get(position)); //le pasamos la fruta que le hemos hecho click
    }
    ...
    //cuando sale una ventana para la eliminacion
    @Override
    ...
    //para los eventos click de la ventana (para eliminar)
    @Override
    ...
    private void switchListGridView(int option) {
        ...
        if (option == SWITCH_TO_LIST_VIEW) {
            ...
            if (this.listView.getVisibility() == View.INVISIBLE) {
                ...
                this.gridView.setVisibility(View.INVISIBLE); //hacemos el grid view invisible
                this.itemGridView.setVisible(true); //el icono lo hacemos visible
